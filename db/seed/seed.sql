...
CREATE TABLE profile (
	...
	instrument_id INTEGER REFERENCES instrument(instrument_id) NOT NULL,
	level_id INTEGER REFERENCES levels(level_id) NOT NULL,
	experience_id INTEGER REFERENCES experience(experience_id) NOT NULL,
...
CREATE TABLE matches (
	...
	chatroom_id INTEGER REFERENCES chatroom(chatroom_id) DEFAULT NULL,
...
CREATE TABLE message (
	...
	message_sender INTEGER REFERENCES users(user_id) NOT NULL,
